...
export default function ScheduleForm({
  ...
  return (
    <div className="fixed inset-0 bg-white z-50 flex flex-col animate-[modalIn_0.15s_ease-out]" style={{ paddingTop: "var(--safe-top)", paddingBottom: "var(--safe-bottom)" }}>
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4" id="scheduleForm">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-400 focus:border-transparent outline-none touch-manipulation"
            />
          </div>
