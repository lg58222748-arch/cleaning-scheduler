...
A. 철수 상황은 다음과 같습니다: 겨울철 온수 미공급, 베이크아웃으로 집안이 고온인 경우, 단수, 전기 단전, 인테리어 공사 후 미고지, 안내 평수와 실제 평수가 다른 경우, 직원을 무시하는 행동·비속어·폭언·언성을 높이는 경우, 과도한 서비스 요구 시 작업을 철수할 수 있음을 미리 말씀드립니다.

새집느낌은 후기와 마찬가지로 항상 최선의 퀄리티와 만족을 위해 모든 팀원이 노력하고 있습니다. 참고하셔서 웃으면서 마무리하는 청소가 되셨으면 좋겠습니다.

감사합니다.`,
  },
  {
    label: "2. 예약/변경/취소 안내",
    text: `확인했습니다! 예약해주셔서 감사드립니다!
...
* 탄성코트와 입주청소 날짜는 최소 7일입니다.`,
  ...
  {
    label: "3. 해피콜 + 인터넷 할인 안내",
    text: `위 내용 꼭 숙지해주시길 부탁드립니다!
...
아참 그리구요 이번에 이사하실때 인터넷도 알아보고 계시다면 1644-0199로 연락주시면
